...
<header>
    <div id="top-header">
        <div id="header-logo-container">
            ...
            <a href="<?php echo Config::get("root/path");?>index.php" style="height: 38px"><img src="<?php echo Config::get("root/path");?>public/assets/images/logos/vedant.png" alt="Logo" id="header-logo"></a>
        </div>
